    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setSpaceOnClickListener(new SpaceOnClickListener() {
            ...
            public void onCentreButtonClick() {
                Toast.makeText(SearchActivity.this,"SCAN", Toast.LENGTH_SHORT).show();
            ...
            public void onItemClick(int itemIndex, String itemName) {
                ...
                if (itemIndex == 0){
                    ...
                    Toast.makeText(SearchActivity.this, "CELLAR", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(SearchActivity.this, CellarActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_up, R.anim.slide_out_up);
                } else if (itemIndex == 2) {
                    Toast.makeText(SearchActivity.this, "LIKE", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(SearchActivity.this, "BUG", Toast.LENGTH_SHORT).show();
                }
